...
class TransNetV2:
    ...
    def predict_video_2(self, video_path):
        """
        预测视频中的场景转换
        """
        # 确保视频路径格式正确
        ...
        print(f"[TransNetV2] Extracting frames from {video_path}")
        ...
        try:
            ...
            clip = clip.with_effects([vfx.Resize(new_size=(48, 27))])
            ...
            print(f"[TransNetV2] Error processing video: {str(e)}")
            raise
